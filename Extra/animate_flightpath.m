...
function FileName = animate_flightpath(FileName, P_mech_last_cycle,...
    Path_last_cycle, EulAng_last_cycle, Tether_last_cycle_x,...
    Tether_last_cycle_y, Tether_last_cycle_z, ENVMT,Wingspan, Tend,fps)
...
% :param P_mech_last_cycle: Instantaneous power.
% :param Path_last_cycle: Aircraft position.
% :param EulAng_last_cycle: Aircraft orientation angles.
% :param Tether_last_cycle_x: Tether particle x positions.
% :param Tether_last_cycle_y: Tether particle y positions.
% :param Tether_last_cycle_z: Tether particle z positions.
% :param ENVMT: Environment data for wind direction.
% :param Wingspan: Kite wing span.
...
fanimator(axes1,@animation_aircraft,Path_last_cycle,EulAng_last_cycle,...
    ENVMT.windDirection_rad,index_set,scale,Tend,fps,t,...
    'AnimationRange',[0 Tend],'FrameRate',fps)
...
aircraft_scale = scale*(55/Wingspan); % STL file contains aircraft with 55m wingspan
% Create textbox
annotation(figure(1),'textbox',...
    [0.0581428571428571 0.0452488687782827 0.210428571428571 0.0407239819004553],...
    'String',{['Kite illustrated at scale: ' num2str(round(aircraft_scale,1)) ':1']},...
    'FontSize',16,...
    'FontAngle','italic',...
    'FitBoxToText','off',...
    'EdgeColor','none');

%Aply axis limits again as correction of any changed values
axes1.XLim = limitx;
axes1.YLim = limity;
axes1.ZLim = limitz;
