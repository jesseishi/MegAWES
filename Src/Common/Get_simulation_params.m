...
%------------- BEGIN CODE --------------
    ...
    if Kite_DOF == 3
        ...
        params.kite_Ft_max=1.425e6;  % 1.425e6 if use_Zgraggen=true, 1.251e6 or 1.364e6 if use_Zgraggen=false.
    ...
    elseif Kite_DOF == 6
        ...
        params.winch_Ft_max=1.262e6;  % 1.390e6 if use_Zgraggen=true, 1.384 if use_Zgraggen=false.
        params.kp_traction_winch=2.5;%0.2;
        params.ki_traction_winch=0.8;%0.4;
